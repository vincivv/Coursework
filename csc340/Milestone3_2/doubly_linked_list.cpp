/**
* @author - Ian Kligman
* @file doubly_linked_list.cpp -  This file contains the methods for doubly linked list.
* 2/7/2025 - I. Kligman created file and added constructor.
* 2/8/2025 - I. Kligman wrote isEmpty and insert methods + comments.
* 2/10/2025 - I. Kligman wrote all remove and move methods + comments.
* 2/10/2025 - I Kligman used AI tools to debug a memory leak issue in removeHeaderNode(). First implementation failed to delete head and left a dangling pointer.
* 2/11/2025 - I Kligman used AI tools to debug a build error. Destructor was missing.
* 2/11/2025 - I Kligman added destructor.
* 2/11/2025 - I Kligman fixed logic in move functions.
* 3/19/2025 - I Kligman incorporated generate output methods for milestone 3.
*/
