...
void BinarySearchTree::printInOrder() const {
    ...
    getOutFile() << "Performing In-order traversal" << std::endl;
...
void BinarySearchTree::printReverseOrder() const {
    ...
    getOutFile() << "Performing Reverse-order traversal" << std::endl;
...
void BinarySearchTree::printDepthFirst() const {
    ...
    std::cout << "Performing Pre-order traversal" << std::endl;
    getOutFile() << "Performing Depth First via PreOrder traversal" << std::endl;
    getOutFile() << "Performing Pre-order traversal" << std::endl;
    printPreOrderHelper(root);
}
...
void BinarySearchTree::printBreadthFirst() const {
    ...
    getOutFile() << "Performing Breadth First traversal" << std::endl;
    if (!root) return;
    ...
    while (!q.empty()) {
        ...
        getOutFile() << "Node key: " << current->key  << std::endl;
...
void BinarySearchTree::printInOrderHelper(TreeNode* node) const {
    ...
    std::cout << "Node key: " << node->key << std::endl;
    getOutFile() << "Node key: " << node->key << std::endl;
...
//Helper function for range traversal
void BinarySearchTree::printRangeHelper(TreeNode* node, int low, int high) {
    if (!node) return;
    if (node->key > low) printRangeHelper(node->left, low, high);
    if (node->key >= low && node->key <= high) {
        std::cout << "Node key: " << node->key << std::endl;
        getOutFile() << "Node key: " << node->key << std::endl;
    }
    if (node->key < high) printRangeHelper(node->right, low, high);
}