...
typedef struct personalInfo 
    ...
    char * lastName;
    int studentID;
    enum gradelevel {FRESHMAN=7, SOPHMORE, JUNIOR, SENIOR, GRAD, INSTRUCTOR} level;
...
int checkIt (void);				//Called at the end of your program, checks results
